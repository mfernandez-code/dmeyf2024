...
FErf_attributes_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$train$clase01_valor1 <- c( "BAJA+2") ##MODIFICADO, "BAJA+1")
...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$clase_minoritaria <- c( "BAJA+2") ##MODIFICADO, "BAJA+2")
  ...
  param_local$train$clase_minoritaria <- c( "BAJA+2") ##MODIFICADO, "BAJA+2")
...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$train$clase_minoritaria <- c( "BAJA+2") ##MODIFICADO, "BAJA+1")
